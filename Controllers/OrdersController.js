...
const createOrder = async(req, res) => {
    try {
        ...
        Restaurant.updateOne({_id: Restaurant._id}, { cant_customers: cantidad_clientes, profit: profitAcum, cant_orders: cantOrdersDB, saucer_most_selling: mostSoldSaucer}).then(() => {
